...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  nowpayments: [
    ...
    { key: 'apiBase', label: '', sensitive: false, defaultValue: 'https://api.nowpayments.io/v1', optional: true },
    { key: 'priceCurrency', label: '', sensitive: false, defaultValue: 'USD', optional: true, hintKey: 'admin.settings.payment.field_nowpaymentsPriceCurrencyHint' },
    { key: 'payCurrency', label: '', sensitive: false, defaultValue: 'usdt', optional: true, hintKey: 'admin.settings.payment.field_nowpaymentsPayCurrencyHint' },
  ],
}
