  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_nowpaymentsPriceCurrencyHint: 'Fiat currency for pricing, e.g. USD, EUR, CNY. The price shown to users is in this currency, while the actual payment is made with crypto.',
        field_nowpaymentsPayCurrencyHint: 'Default crypto currency for payment. Leave empty to let users choose (e.g. usdt, btc, eth, etc.).',
        nowpaymentsWebhookHint: 'Configure the following URL as the IPN Callback URL in NOWPayments Dashboard → Settings → IPN Callback URL:',
