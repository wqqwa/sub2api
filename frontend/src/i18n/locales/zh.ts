  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        providerNowPayments: 'NOWPayments / U支付',
        typeDisabled: '类型已禁用',
        ...
        field_nowpaymentsPriceCurrencyHint: '计价法币，如 USD、EUR、CNY 等。用户在支付时看到的价格以此币种显示，实际支付时使用加密货币。',
        field_nowpaymentsPayCurrencyHint: '默认支付加密货币。留空或由用户在选择支付时自行选择币种（如 usdt、btc、eth 等）。',
        nowpaymentsWebhookHint: '请在 NOWPayments Dashboard → Settings → IPN Callback URL 中配置以下地址：',
        field_cid: '支付渠道 ID',
